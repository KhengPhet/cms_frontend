        ...
        <div class="p-8">
          ...
          <div class="text-center mt-6 pt-4 border-t border-gray-100">
            <p class="text-sm text-gray-600">
              ...
              <router-link to="/auth/login" class="text-blue-600 font-semibold hover:text-blue-700 hover:underline transition-colors ml-1">
                Login
              </router-link>
            </p>
          </div>
...
import { registerAPI } from "../../services/useAuth";
